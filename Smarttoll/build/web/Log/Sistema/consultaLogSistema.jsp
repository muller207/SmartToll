<%-- 
    Document   : consultaLogSistema
    Created on : 15/12/2014, 15:56:40
...
<html>
    ...
    <body>
        <div id="wrap">	
            ...
            <div id="content" >
                <h1>Logs do Sistema</h1><br><br>               
                    <form action="ConsultaLogSistema" method="post"> 
                        
                        <label for="tipoLog">Tipo de Log</label>
                        <select name="tipoLog" id="tipoLog">
                              <option value=""></option> 
                              <%
                                  TipoLogDAO tdao = new TipoLogDAOImp();
                                  ResultSet logs = tdao.consultaTipoLogTotal();
                                  if(logs!=null){
                                      while(logs.next()){
                              %>
                              <option value="<%= logs.getInt("TIPO_LOG_CODIGO") %>"><%= logs.getString("DESCRICAO") %></option>                  
                              <%
                                      }
                                  }
                              %>
