...
<html>
    <head>        
        ...
        <title>Consulta de Movimentações de Pista Isenta</title>
    </head>
    <body>
        <div id="wrap">	
            <jsp:include page="/Estrutura/menu.jsp" />
            <div id="content">
                <h1>Consulta de Movimentações de Pista Isenta</h1>
                <br><br>
                <br><br>
                ...
                <table border="1" cellspacing="0">
                    ...
                    <%
                        ...
                        if (rs != null) {
                            while (rs.next()) {
                    %>
                    <tr onmouseover="this.style.cursor = 'pointer'; this.className='trOver'" onmouseleave="this.className='trLeave'" ondblclick="window.location.href='consultaRelatorioMovimentacaoPistaIsentaDetalhesRs.jsp?codigo=<%= rs.getString("CAIXAS_MOVIMENTOS_CODIGO")%>'">
