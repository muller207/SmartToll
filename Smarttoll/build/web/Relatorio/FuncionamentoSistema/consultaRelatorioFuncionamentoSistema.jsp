<%-- 
    Document   : consultaRelatorioFuncionamentoSistema
    Created on : 21/11/2014, 13:01:33
...
<html>
    ...
    <body>
        <div id="wrap">	
            ...
            <div id="content" >
                <h1>Relatório de Funcionamento do Sistema</h1><br><br>
                <form id="form" method="POST" action="ConsultaRelatorioFuncionamentoSistema">
                    <br><br>
                    <label>Caixa</label>
