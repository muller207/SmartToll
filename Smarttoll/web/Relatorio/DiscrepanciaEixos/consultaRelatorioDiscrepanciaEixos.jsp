<%-- 
    Document   : consultaRelatorioDiscrepanciaEixos
    Created on : 21/11/2014, 12:53:16
...
<html>
    <head>
        ...
        <title>Movimentação de Discrepância</title>
    </head>
    <body>
        <div id="wrap">	
            <jsp:include page="/Estrutura/menu.jsp" />
            <div id="content" >
                <h1>Relatório de Discrepâncias dos Eixos</h1><br><br>
                <form id="form" method="POST" action="ConsultaRelatorioDiscrepanciaEixos">
                    <br><br>
                    <label>Código do Caixa</label>
                    <input type="number" name="caixa"> 
                    <br><br> 
                    <input type="checkbox" name="discrepancia"> 
                    Exibir somente registros com discrepância                    
                    <br><br>
                    <br><br>
