<%-- 
    Document   : consultaRelatorioMovimentacaoPistaIsenta
    Created on : 21/11/2014, 13:02:13
...
<html>
    <head>
        ...
        <title>Movimentação de Pista Isenta</title>
    </head>
    <body>
        <div id="wrap">	
            <jsp:include page="/Estrutura/menu.jsp" />
            <div id="content" >
                <h1>Relatório de Movimentação de Pista Isenta</h1><br><br>
                <form id="form" method="POST" action="ConsultaRelatorioMovimentacaoPistaIsenta">
                    <br><br>
