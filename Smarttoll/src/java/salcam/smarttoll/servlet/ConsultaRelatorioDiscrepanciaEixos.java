 ...
 */
public class ConsultaRelatorioDiscrepanciaEixos extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if(request.getParameter("dataInicio")!=null && !request.getParameter("dataInicio").isEmpty()){            
            ...
            condicao += " LANCAMENTO >= '"+inicio[0]+inicio[1]+inicio[2]+"' AND";
        }
        ...
        if(request.getParameter("dataFim")!=null && !request.getParameter("dataFim").isEmpty()){            
            ...
            condicao += " LANCAMENTO<= '"+fim[0]+fim[1]+fim[2]+" 23:59:59' AND";
        }
        ...
        CaixaMovimentoDetalheDAO cdao = new CaixaMovimentoDetalheDAOImp();
            ResultSet rs = cdao.consultaCaixaMovimentoDetalhe(condicao);
...
//        session.setAttribute("condicao", condicao);
        ...
        l.setTipoRelatorioCod((byte)2);
        LogRelatorioDAO ldao = new LogRelatorioDAOImp();
        ldao.cadastroLogRelatorio(l);
        RequestDispatcher rd = request.getRequestDispatcher("/Relatorio/DiscrepanciaEixos/consultaRelatorioDiscrepanciaEixosRs.jsp");
