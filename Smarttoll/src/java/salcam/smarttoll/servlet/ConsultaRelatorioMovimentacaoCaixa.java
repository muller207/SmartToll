 ...
 */
public class ConsultaRelatorioMovimentacaoCaixa extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        l.setTipoRelatorioCod((byte)1);
        LogRelatorioDAO ldao = new LogRelatorioDAOImp();
        ldao.cadastroLogRelatorio(l);
        RequestDispatcher rd = request.getRequestDispatcher("/Relatorio/MovimentacaoCaixa/consultaRelatorioMovimentacaoCaixaRs.jsp");
