 ...
 */
public class ConsultaLogRelatorio extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        condicao += (request.getParameter("tipoRelatorio") != null && !request.getParameter("tipoRelatorio").isEmpty())
                ? " l.TIPO_RELATORIO_CODIGO = " + request.getParameter("tipoRelatorio") + " AND" : "";
        ...
        ResultSet rs = ldao.consultaLogRelatorio(condicao);
        request.setAttribute("rs", rs);
        request.setAttribute("condicao", condicao);
        RequestDispatcher rd = request.getRequestDispatcher("/Log/VisualizacaoRelatorios/consultaLogVisualizacaoRelatoriosRs.jsp");
