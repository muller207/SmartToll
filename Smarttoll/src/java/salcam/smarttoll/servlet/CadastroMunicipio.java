 ...
 */
public class CadastroMunicipio extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        m.setMunicipio(request.getParameter("municipio"));
        m.setEstadoCod(request.getParameter("estado"));
        
        MunicipioDAO mdao = new MunicipioDAOImp();
        if(mdao.cadastroMunicipio(m)){
            Alert.Message(response, "Sucesso ao cadastrar municipio", "/Smarttoll/home");
        } else {
            Alert.Message(response, "Falha ao cadastra municipio", "/Smarttoll/home");
        }
    }
