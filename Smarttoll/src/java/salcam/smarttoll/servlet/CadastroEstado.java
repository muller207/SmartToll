...
public class CadastroEstado extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        e.setEstadoCod(request.getParameter("sigla"));
        
        EstadoDAO edao = new EstadoDAOImp();
        if(edao.cadastroEstado(e)){
            Alert.Message(response, "Sucesso ao cadastrar estado", "/Smarttoll/home");
        } else {
            Alert.Message(response, "Falha ao cadastra estado", "/Smarttoll/home");
        }
    }
